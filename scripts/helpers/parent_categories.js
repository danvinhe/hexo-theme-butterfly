...
hexo.extend.helper.register('parent_categories', function () {
  ...
  this.log('parent_categories: pagePath =', pagePath)
  const categories = this.site.categories
  if (!categories || !categories.length) return 'categories is empty'
  this.log('parent_categories: categories.length =',categories.length)
  ...
  this.log('parent_categories: current =', current)
  ...
  do {
    ...
    this.log('parent_categories: parentId =', parentId)
  } while (parentId);
